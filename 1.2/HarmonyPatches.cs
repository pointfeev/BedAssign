...
public static class HarmonyPatches
{
    ...
    {
        Harmony harmony = new("pointfeev.bedassign");
        _ = harmony.Patch(AccessTools.Method(typeof(JobGiver_GetRest), "TryGiveJob"), new(typeof(HarmonyPatches), nameof(JobPrefix)));
        _ = harmony.Patch(AccessTools.Method(typeof(Building_Bed), nameof(Building_Bed.GetGizmos)), postfix: new(typeof(HarmonyPatches), nameof(GizmoPostfix)));
    }
