...
namespace BedAssign
{
    public static class PawnBedUtils
    {
        ...
        public static bool IsBetterThan(this Building_Bed bed, Building_Bed currentBed, Pawn pawn)
        {
            ...
            float currentImpressiveness = currentRoom.GetStat(RoomStatDefOf.Impressiveness) + ModSettings.betterBedRoomImpressivenessThreshold;
            if (impressiveness > currentImpressiveness)
